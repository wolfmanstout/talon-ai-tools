...
{user.model} [{user.thread}] {user.modelAction} ([with {user.modelSource}] <user.modelSimplePrompt> | <user.modelSimplePrompt> {user.modelSource})$:
    user.gpt_apply_prompt(modelSimplePrompt, model, thread or "", modelSource or "", modelAction)
