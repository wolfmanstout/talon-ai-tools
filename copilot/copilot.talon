...
pilot edit keep: user.vscode("chatEditor.action.acceptHunk")
pilot edit keep file: user.vscode("chatEditor.action.keep")
pilot edit keep all: user.vscode("chatEditing.acceptAllFiles")
pilot edit undo: user.vscode("chatEditor.action.undoHunk")
pilot edit undo file: user.vscode("chatEditor.action.reject")
pilot edit undo all: user.vscode("chatEditing.discardAllFiles")
