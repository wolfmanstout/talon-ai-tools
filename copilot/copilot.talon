...
pilot file edit: user.vscode("github.copilot.edits.attachFile")
pilot file chat: user.vscode("github.copilot.chat.attachFile")
pilot edit next: user.vscode("chatEditor.action.navigateNext")
pilot edit last: user.vscode("chatEditor.action.navigatePrevious")
pilot edit accept: user.vscode("chatEditor.action.accept")
pilot edit discard: user.vscode("chatEditor.action.reject")
pilot edit (revert | undo): user.vscode("chatEditor.action.undoHunk")
